...
import os, re
import json
from HGCalCommissioning.LocalCalibration.plot.wafer import getlimits, getzlimits, fill_wafer_hist
try:
  ...
  print(f">>> Warning! Got: \"{error.msg}\" Proceeding without plotly...")
