...
namespace hgcal_slinkfromraw {
  ...
  public:
    ...
    inline uint32_t numberOfSeconds() const {
      return _payload[1]&0xffffffff;
    }

    inline uint32_t numberOfSpills() const {
      return _payload[1]>>32;
    }

    inline uint32_t numberOfPauses() const {
    ...
    inline void setNumberOfSeconds(uint32_t s) {
      _payload[1]&=0xffffffff00000000;
      _payload[1]|=s;
    }
   
    inline void setNumberOfSpills(uint32_t s) {
      _payload[1]&=0x00000000ffffffff;
      _payload[1]|=uint64_t(s)<<32;
    }
   
    inline void setNumberOfPauses(uint32_t p) {
